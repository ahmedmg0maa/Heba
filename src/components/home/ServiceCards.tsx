...
const services = [
  {
    ...
    number: '٠١',
    title: 'الكتب',
    text: 'استعرضي الكتب المنشورة وتفاصيلها قبل الشراء.',
  ...
  },
  {
    ...
    number: '٠٢',
    title: 'الدورات',
    text: 'تصفّحي البرامج المتاحة ومحتوى كل مسار وطريقة الوصول إليه.',
  ...
  },
  {
    ...
    number: '٠٣',
    title: 'الجلسات',
    text: 'اختاري الخدمة ثم اطلعي على المواعيد المتاحة قبل تأكيد الحجز.',
  ...
  },
  {
    ...
    number: '٠٤',
    title: 'ورش العمل',
    text: 'تابعي الورش المنشورة ومواعيدها وحالة المقاعد من صفحة واحدة.',
    ...
    <section className="heritage-paper border-b border-line bg-ivory px-5 py-14 sm:px-8 md:py-20" aria-labelledby="service-gates-title">
      <div className="mx-auto max-w-7xl">
        <header className="mx-auto mb-10 max-w-2xl text-center">
          <p className="text-xs font-bold tracking-[.18em] text-antique-gold">اختاري الباب الأقرب</p>
          <h2 id="service-gates-title" className="mt-3 text-3xl font-bold text-deep-teal sm:text-4xl">مسارات واضحة في مكان واحد</h2>
          <p className="mt-3 leading-loose text-text-soft">ابدئي بالتصفّح، واقرئي التفاصيل المنشورة قبل اتخاذ القرار.</p>
        </header>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="flex items-start justify-between">
                <span className="font-heading text-sm text-antique-gold">{service.number}</span>
                <span className="flex h-13 w-13 items-center justify-center rounded-full border border-antique-gold/30 text-deep-teal transition-colors group-hover:bg-deep-teal group-hover:text-on-dark" aria-hidden>
                  <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="1.5">{service.icon}</svg>
                </span>
              </div>
