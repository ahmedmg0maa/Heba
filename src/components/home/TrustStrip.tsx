import { DEFAULT_HOME_CONTENT, type TrustContent } from '@/lib/home/sections'
...
export function TrustStrip({ content = DEFAULT_HOME_CONTENT.trust as TrustContent }: { content?: TrustContent }) {
  return (
