...
export function Testimonials({ testimonials }: { testimonials: HomeTestimonial[] }) {
  ...
  return (
    <section className="bg-sand/30 px-6 py-16 md:py-24">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <figure className="mt-12 flex min-h-56 flex-col items-center justify-center gap-6 rounded-3xl border border-line bg-soft-white p-10 shadow-card">
