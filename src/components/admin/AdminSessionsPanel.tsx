...
export function AdminSessionsPanel({ sessions }: { sessions: Session[] }) {
  ...
  return <section className="space-y-4">
    ...
    {sessions.length === 0 ? <p className="rounded-xl bg-ivory/60 px-4 py-3 text-sm text-text-soft">لا توجد جلسات إدارية نشطة.</p> : <ul className="divide-y divide-line/70 rounded-xl border border-line/70 bg-surface-raised">
