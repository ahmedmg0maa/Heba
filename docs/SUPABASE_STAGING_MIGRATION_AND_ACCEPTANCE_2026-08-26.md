...
> تحديث مصدر محلي في 2026-08-28: تطور التسلسل المحلي بعد هذا الدليل التاريخي إلى `000–072` (73 ملفًا). بقيت Production موثقة عند `000–043` فقط، ولم تُطبق `044–072` على أي مزود في هذه الجولة؛ يجب تشغيلها بالترتيب داخل Staging المستقل بعد Recovery Point وschema fingerprint معتمدين.
