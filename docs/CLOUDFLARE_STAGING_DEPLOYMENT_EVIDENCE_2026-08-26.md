...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–071 بعد العقد الخارجي 044–047. آخرها 071 ينشئ طلب حذف حساب قابلًا للتتبع مع مراجعة وصلاحية وتدقيق وإثبات عدم وجود الهوية قبل الاكتمال؛ و070 يلغي منح Admin من Trigger التسجيل. لا يغيّر هذا حكم Staging: لم تُطبق هذه migrations على مزود، وتبقى RLS والـtriggers والتزامن وAuth/الحذف الفعلي `unverified` حتى نافذة Staging المفوضة واعتماد سياسة الاحتفاظ.
