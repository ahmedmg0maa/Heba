...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–066 بعد العقد الخارجي 044–047. آخرها 066 يحفظ قراءة سجل العميلة المملوك بعد سحبه من الاكتشاف العام، ويقفل Dashboard على قراءات bounded/fail-closed مع next action حقيقي، واجتاز Next وWorkers **70/70**. لا يغيّر هذا حكم Staging: لم تُطبق 066 أو أي migration أخرى على مزود، وتبقى جميع أدلة SQL/RLS/Storage/persistence الحية `unverified` حتى بوابة الاستعادة والترحيل المفوضة.
