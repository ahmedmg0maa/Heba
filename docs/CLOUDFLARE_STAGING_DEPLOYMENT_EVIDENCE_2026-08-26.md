...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–063 بعد العقد الخارجي 044–047. آخرها 063 يغلق التسعير/الطلب المتكرر ورفع إثبات الدفع المباشر المفحوص محليًا، واجتاز Next وWorkers **70/70**. لا يغيّر هذا حكم Staging: لم تُطبق 063 أو أي migration أخرى على مزود، وتبقى جميع أدلة SQL/RLS/Storage/persistence الحية `unverified` حتى بوابة الاستعادة والترحيل المفوضة.
