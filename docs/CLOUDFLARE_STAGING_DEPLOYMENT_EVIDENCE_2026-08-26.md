...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–073 بعد العقد الخارجي 044–047. آخرها 073 يحكم عمليات المنهج ذريًا ويمنع raw video path وحذف سجل التسليم/العميلة؛ و072 يصدر intent خاصًا قبل توقيع الرفع ثم يجعل الربط والفحص والتدقيق ذريًا. لا يغيّر هذا حكم Staging: لم تُطبق هذه migrations على مزود، وتبقى SQL/RLS/Storage/التزامن وAuth/الحذف الفعلي `unverified` حتى نافذة Staging المفوضة واعتماد سياسة الاحتفاظ.
