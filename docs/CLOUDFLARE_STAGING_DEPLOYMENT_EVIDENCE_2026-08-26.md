...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–067 بعد العقد الخارجي 044–047. آخرها 067 يلغي تعديل profile/notification المباشر من المتصفح ويستبدله بعقود خدمة ذرّية مرتبطة بهوية العميلة ومُدققة دون محتوى شخصي. لا يغيّر هذا حكم Staging: لم تُطبق 067 أو أي migration أخرى على مزود، وتبقى جميع أدلة SQL/RLS/Storage/persistence الحية `unverified` حتى بوابة الاستعادة والترحيل المفوضة.
