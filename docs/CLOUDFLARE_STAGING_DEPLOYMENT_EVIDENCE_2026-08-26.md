...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–069 بعد العقد الخارجي 044–047. آخرها 069 ينقل إلغاء/تغيير حجز العميلة إلى عقود service-only مرتبطة بهوية صريحة مع سياسة/slot/audit ذرّي، ويصحح توقيت القاهرة وICS الخاص. لا يغيّر هذا حكم Staging: لم تُطبق 069 أو أي migration أخرى على مزود، وتبقى RLS والـtriggers والتزامن والاستيراد الفعلي إلى تطبيق تقويم `unverified` حتى نافذة Staging المفوضة.
