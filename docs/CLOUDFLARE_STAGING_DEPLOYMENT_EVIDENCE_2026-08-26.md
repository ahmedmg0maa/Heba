...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–077 بعد العقد الخارجي 044–047. تحكم 072–074 الرفع/المنهج/إزالة التسليم المحمي، وتجعل 075–077 أقسام CMS والقوائم ودورة الصفحة معاملات ذرّية مدققة مع حماية الصفحة الرئيسية والقانونيات والجدولة. لا يغيّر هذا حكم Staging: لم تُطبق هذه migrations على مزود، وتبقى SQL/RLS/Storage/التزامن وAuth والحذف/النشر الفعلي `unverified` حتى نافذة Staging المفوضة واعتماد المحتوى والسياسات.
