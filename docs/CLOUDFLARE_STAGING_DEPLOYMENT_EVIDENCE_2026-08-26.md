...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–075 بعد العقد الخارجي 044–047. تحكم 072–074 الرفع/المنهج/إزالة التسليم المحمي، وتجعل 075 revision/mutation/audit لأقسام CMS معاملة واحدة وتحمي أقسام الصفحة الرئيسية المنشورة. لا يغيّر هذا حكم Staging: لم تُطبق هذه migrations على مزود، وتبقى SQL/RLS/Storage/التزامن وAuth والحذف/النشر الفعلي `unverified` حتى نافذة Staging المفوضة واعتماد المحتوى والسياسات.
