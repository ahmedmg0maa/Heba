...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–070 بعد العقد الخارجي 044–047. آخرها 070 يلغي منح Admin من Trigger التسجيل ويقيد Profile metadata مع audit ذرّي؛ و069 يحكم إلغاء/تغيير حجز العميلة ويصحح توقيت القاهرة وICS الخاص. لا يغيّر هذا حكم Staging: لم تُطبق هذه migrations على مزود، وتبقى RLS والـtriggers والتزامن وAuth/التقويم الفعلي `unverified` حتى نافذة Staging المفوضة.
