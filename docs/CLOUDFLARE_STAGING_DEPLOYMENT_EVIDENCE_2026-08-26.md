...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–074 بعد العقد الخارجي 044–047. تحكم 073 عمليات المنهج ذريًا وتمنع raw video path وحذف سجل التسليم/العميلة؛ تصدر 072 intent خاصًا قبل توقيع الرفع؛ وتضيف 074 أرشفة الملفات المحمية، منع وصول العميلة، إلغاء جلسات الفيديو ودليل تنظيف Storage منفصلًا بلا مسارات خام. لا يغيّر هذا حكم Staging: لم تُطبق هذه migrations على مزود، وتبقى SQL/RLS/Storage/التزامن وAuth/الحذف الفعلي `unverified` حتى نافذة Staging المفوضة واعتماد سياسة الاحتفاظ.
