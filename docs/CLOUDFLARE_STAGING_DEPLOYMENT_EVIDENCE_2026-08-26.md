...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–064 بعد العقد الخارجي 044–047. آخرها 064 يغلق كتابة تقدّم التعلّم والملاحظات الخاصة خلف enrollment وRPC ذري مفحوص محليًا، واجتاز Next وWorkers **70/70**. لا يغيّر هذا حكم Staging: لم تُطبق 064 أو أي migration أخرى على مزود، وتبقى جميع أدلة SQL/RLS/Storage/persistence الحية `unverified` حتى بوابة الاستعادة والترحيل المفوضة.
