...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–072 بعد العقد الخارجي 044–047. آخرها 072 يصدر intent خاصًا قبل توقيع الرفع ثم يجعل ربط ملف التسليم المحمي وإغلاق الـintent ونتيجة الفحص والتدقيق عملية ذرية، ويُظهر فشل تنظيف Storage دون كشف المسار؛ و071 ينشئ طلب حذف حساب قابلًا للتتبع، و070 يلغي منح Admin من Trigger التسجيل. لا يغيّر هذا حكم Staging: لم تُطبق هذه migrations على مزود، وتبقى SQL/RLS/Storage/التزامن وAuth/الحذف الفعلي `unverified` حتى نافذة Staging المفوضة واعتماد سياسة الاحتفاظ.
