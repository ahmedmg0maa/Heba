...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–068 بعد العقد الخارجي 044–047. آخرها 068 يسجل نتيجة تغيير كلمة المرور عبر حد Auth الخارجي دون أي credential، بينما أصبح الاسترداد يمر عبر SSR PKCE callback داخلي محدود. لا يغيّر هذا حكم Staging: لم تُطبق 068 أو أي migration أخرى على مزود، ويجب إدراج `/auth/callback` للـorigin المعتمد في Auth redirects واختبار البريد/AMR والجلسات حيًا قبل القبول.
