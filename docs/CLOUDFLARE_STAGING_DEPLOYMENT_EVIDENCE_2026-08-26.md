...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–062 بعد العقد الخارجي 044–047. آخرها 062 يغلق حوكمة إثبات الدفع اليدوي ودورة الاسترداد الصادقة محليًا، واجتاز Next وWorkers **70/70**. لا يغيّر هذا حكم Staging: لم تُطبق 062 أو أي migration أخرى على مزود، وتبقى جميع أدلة SQL/RLS/Storage/persistence الحية `unverified` حتى بوابة الاستعادة والترحيل المفوضة.
