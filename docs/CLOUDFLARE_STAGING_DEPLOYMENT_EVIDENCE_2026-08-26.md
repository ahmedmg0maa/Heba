...
> تحديث مصدر محلي في 2026-08-28: أضيفت migrations 048–078. تحكم 072–074 التسليم المحمي، وتجعل 075–078 أقسام CMS والقوائم ودورتي الصفحة والمقال معاملات ذرّية مدققة مع حواجز القانونيات والحقوق والجدولة. لا يغيّر هذا حكم Staging؛ لم تُطبق على مزود وتبقى الأدلة الحية `unverified`.
